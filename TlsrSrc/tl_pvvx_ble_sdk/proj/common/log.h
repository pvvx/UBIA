...
static inline void swire2usb_init (void) {
	reg_usb_ep8_buf_addr = 0; // U8_SET(0x800128, 0x00);
	reg_usb_ep5_buf_addr = 0; // U8_SET(0x80012d, 0);
	reg_usb_ep8_send_max = 0; // U8_SET(0x80013b, 32);
}

static inline void usb_log_init (void) {
	reg_usb_ep8_send_thre = 0x40; // U8_SET(0x80013c, 0x40);
	reg_usb_ep8_fifo_mode = 0x09; // U8_SET(0x80013d, 0x09);
}
